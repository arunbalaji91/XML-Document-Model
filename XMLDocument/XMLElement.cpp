...
std::shared_ptr<AbstractXmlElement> XmlProcessing::makeXmlDeclarElement(const std::string& text)
{
	std::shared_ptr<AbstractXmlElement> ptr(new XmlDeclarElement(text));
	return ptr;
}
...
//----< Move constructor for TaggedElement >-----------------
...
//
//TaggedElement::TaggedElement(TaggedElement&& other) :tag_(nullptr)
//{
//
//}
